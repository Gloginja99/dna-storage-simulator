...
const SR: Translations = {
  ...
  'about.tech.mongoSub': 'Baza podataka (implementirano)',
  ...
  'about.status.auth': 'Autentifikacija korisnika (implementirano)',
...
const EN: Translations = {
  ...
  'about.tech.nodeSub': 'Backend',
  'about.tech.mongo': 'MongoDB',
  'about.tech.mongoSub': 'Database (implemented)',
  ...
  'about.status.backend': 'Backend API',
  'about.status.auth': 'User Authentication (implemented)',
